...
from melreformer.core.vocoder.discriminator._types import (
    DiscriminatorOutput,
    MpdOutput,
    MsdOutput,
    UniOutput,
)
from melreformer.core.vocoder.discriminator.components.mpd import MultiPeriodDiscriminator
from melreformer.core.vocoder.discriminator.components.msd import MultiScaleDiscriminator
